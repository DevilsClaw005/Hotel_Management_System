...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        {
            JOptionPane.showMessageDialog(null, "Invalid Age. Please enter a numeric value");
            return;
        ...
        {
            JOptionPane.showMessageDialog(null, "Invalid Salary. Please enter a numeric value");
            return;
        } else if(!phone.matches("\\d+"))
        {
            JOptionPane.showMessageDialog(null, "Invalid Phone Number. Please enter a numeric value");
            return;
        } else if (!isValidEmail(email)) {
        JOptionPane.showMessageDialog(null, "Invalid Email. Please enter a valid email address.");
        return;
        } else if(!aadhar.matches("\\d+"))
        {
            JOptionPane.showMessageDialog(null, "Invalid Aadhar. Please enter a numeric value");
            return;
        }
